/**
 ...
 (function () {
  ...
  var cancelTimedUpload = function (imageUploadTimerState) {
    // console.log(global$imageUploadTimerState);
    ...
    return ir.toBlob().then(function (blob) {
      ...
      editor.undoManager.transact(function () {
        var imageLoadedHandler = function () {
            ...
            selectedImage.removeEventListener('load', imageLoadedHandler);
          editor.nodeChanged();
        ...
        selectedImage.addEventListener('load', imageLoadedHandler);
        if (size) {
          selectedImage.setAttribute("width", size.w)
          selectedImage.setAttribute("height", size.h)
          // selectedImage.setAttribute({
          //   width: size.w,
          //   height: size.h
          // });
        }
        selectedImage.setAttribute("src", blobInfo.blobUri())
